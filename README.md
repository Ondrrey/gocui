...
[![Go Reference](https://pkg.go.dev/badge/github.com/ondrrey/gocui.svg)](https://pkg.go.dev/github.com/ondrrey/gocui)
...
```
$ go get github.com/ondrrey/gocui
```
...
```
$ go doc github.com/ondrrey/gocui
```

Or visit [pkg.go.dev](https://pkg.go.dev/github.com/ondrrey/gocui) to read
it online.
